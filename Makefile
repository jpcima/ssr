...
res:
	$(MAKE) res -C plugins/ssr

plugins: libs res
	$(MAKE) all -C plugins/ssr
...
clean:
	...
	$(MAKE) clean -C libs/strings
	$(MAKE) clean -C dpf/utils/lv2-ttl-generator
	$(MAKE) clean -C plugins/ssr
	rm -rf bin build

install: all
	$(MAKE) install -C plugins/ssr

install-user: all
	$(MAKE) install-user -C plugins/ssr
