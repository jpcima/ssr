...
void ResonantArrayAVX::init(float sampleRate, unsigned maxStrings)
{
    const unsigned maxStringPacks = (maxStrings + avxVectorSize - 1) / avxVectorSize;
...
{
    const unsigned maxStringPacks = (_maxStrings + avxVectorSize - 1) / avxVectorSize;
    ResonantStringAVX* stringPacks = _stringPacks.data();
